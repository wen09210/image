...
for ( i in { radio: true, checkbox: true, file: true, image: true } ) {
...
/* jquery uniform min*/
(function(f,y){function h(a){var b=Array.prototype.slice.call(arguments,1);return a.prop?a.prop.apply(a,b):a.attr.apply(a,b)}function k(a,b,c){var d,e;for(d in c)c.hasOwnProperty(d)&&(e=d.replace(/ |$/g,b.eventNamespace),a.bind(e,c[d]))}function l(a,b,c){k(a,c,{focus:function(){b.addClass(c.focusClass)},blur:function(){b.removeClass(c.focusClass);b.removeClass(c.activeClass)},mouseenter:function(){b.addClass(c.hoverClass)},mouseleave:function(){b.removeClass(c.hoverClass);b.removeClass(c.activeClass)},
"mousedown touchbegin":function(){a.is(":disabled")||b.addClass(c.activeClass)},"mouseup touchend":function(){b.removeClass(c.activeClass)}})}function p(a,b){a.removeClass(b.hoverClass+" "+b.focusClass+" "+b.activeClass)}function q(a,b,c){var d=b.is(":checked");b.prop?b.prop("checked",d):d?b.attr("checked","checked"):b.removeAttr("checked");b=c.checkedClass;d?a.addClass(b):a.removeClass(b)}function n(a,b,c){c=c.disabledClass;b.is(":disabled")?a.addClass(c):a.removeClass(c)}function t(a,b,c){switch(c){case "after":return a.after(b),
a.next();case "before":return a.before(b),a.prev();case "wrap":return a.wrap(b),a.parent()}return null}function r(a,b,c){var d,e,g;return c||(c={}),c=f.extend({bind:{},divClass:null,divWrap:"wrap",spanClass:null,spanHtml:null,spanWrap:"wrap"},c),d=f("<div />"),e=f("<span />"),b.autoHide&&a.is(":hidden")&&"none"===a.css("display")&&d.hide(),c.divClass&&d.addClass(c.divClass),b.wrapperClass&&d.addClass(b.wrapperClass),c.spanClass&&e.addClass(c.spanClass),g=h(a,"id"),b.useID&&g&&h(d,"id",b.idPrefix+
"-"+g),c.spanHtml&&e.html(c.spanHtml),d=t(a,d,c.divWrap),e=t(a,e,c.spanWrap),n(d,a,b),{div:d,span:e}}function w(a,b){var c;return b.wrapperClass?(c=f("<span />").addClass(b.wrapperClass),t(a,c,"wrap")):null}function G(){var a,b,c;return b=f('<div style="width:0;height:0;color:rgb(120,2,153)">'),f("body").append(b),c=b.get(0),a=window.getComputedStyle?window.getComputedStyle(c,"").color:(c.currentStyle||c.style||{}).color,b.remove(),"rgb(120,2,153)"!==a.replace(/ /g,"")}function z(a){var b;return a[0].multiple?
!0:(b=h(a,"size"),!b||1>=b?!1:!0)}function u(){return!1}function v(a,b){k(a,b,{"selectstart dragstart mousedown":u});a.css({MozUserSelect:"none",msUserSelect:"none",webkitUserSelect:"none",userSelect:"none"})}function A(a,b,c){a=a.val();""===a?a=c.fileDefaultHtml:(a=a.split(/[\/\\]+/),a=a[a.length-1]);b.text(a)}function B(a,b,c){var d;d=[];a.each(function(){for(var a in b)Object.prototype.hasOwnProperty.call(b,a)&&(d.push({el:this,name:a,old:this.style[a]}),this.style[a]=b[a])});for(c();d.length;)a=
d.pop(),a.el.style[a.name]=a.old}function C(a,b){var c;c=a.parents();c.push(a[0]);c=c.not(":visible");B(c,{visibility:"hidden",display:"block",position:"absolute"},b)}function D(a,b){return function(){a.unwrap().unwrap().unbind(b.eventNamespace)}}var x=!0,E=!1,F=[{match:function(a){return a.is("a, button, :submit, :reset, input[type='button']")},apply:function(a,b){var c,d,e,g,m;return d=b.submitDefaultHtml,a.is(":reset")&&(d=b.resetDefaultHtml),g=a.is("a, button")?function(){return a.html()||d}:
function(){var b=h(a,"value");return(b?f("<span />").text(b).html():"")||d},e=r(a,b,{divClass:b.buttonClass,spanHtml:g()}),c=e.div,l(a,c,b),m=!1,k(c,b,{"click touchend":function(){var b,c,d,e;m||a.is(":disabled")||(m=!0,a[0].dispatchEvent?(b=document.createEvent("MouseEvents"),b.initEvent("click",!0,!0),c=a[0].dispatchEvent(b),a.is("a")&&c&&(d=h(a,"target"),e=h(a,"href"),d&&"_self"!==d?window.open(e,d):document.location.href=e)):a.click(),m=!1)}}),v(c,b),{remove:function(){return c.after(a),c.remove(),
a.unbind(b.eventNamespace),a},update:function(){p(c,b);n(c,a,b);a.detach();e.span.html(g()).append(a)}}}},{match:function(a){return a.is(":checkbox")},apply:function(a,b){var c,d,e;return c=r(a,b,{divClass:b.checkboxClass}),d=c.div,e=c.span,l(a,d,b),k(a,b,{"click touchend":function(){q(e,a,b)}}),q(e,a,b),{remove:D(a,b),update:function(){p(d,b);e.removeClass(b.checkedClass);q(e,a,b);n(d,a,b)}}}},{match:function(a){return a.is(":file")},apply:function(a,b){function c(){A(a,g,b)}var d,e,g,m;return d=
r(a,b,{divClass:b.fileClass,spanClass:b.fileButtonClass,spanHtml:b.fileButtonHtml,spanWrap:"after"}),e=d.div,m=d.span,g=f("<span />").html(b.fileDefaultHtml),g.addClass(b.filenameClass),g=t(a,g,"after"),h(a,"size")||h(a,"size",e.width()/10),l(a,e,b),c(),navigator.cpuClass&&!navigator.product?k(a,b,{click:function(){console.log("click ");a.trigger("change");setTimeout(c,0)}}):k(a,b,{change:c}),v(g,b),v(m,b),{remove:function(){return g.remove(),m.remove(),a.unwrap().unbind(b.eventNamespace)},update:function(){p(e,
b);A(a,g,b);n(e,a,b)}}}},{match:function(a){return a.is("input")?(a=(" "+h(a,"type")+" ").toLowerCase(),0<=" color date datetime datetime-local email month number password search tel text time url week ".indexOf(a)):!1},apply:function(a,b){var c,d;return c=h(a,"type"),a.addClass(b.inputClass),d=w(a,b),l(a,a,b),b.inputAddTypeAsClass&&a.addClass(c),{remove:function(){a.removeClass(b.inputClass);b.inputAddTypeAsClass&&a.removeClass(c);d&&a.unwrap()},update:u}}},{match:function(a){return a.is(":radio")},
apply:function(a,b){var c,d,e;return c=r(a,b,{divClass:b.radioClass}),d=c.div,e=c.span,l(a,d,b),k(a,b,{"click touchend":function(){f.uniform.update(f(':radio[name="'+h(a,"name")+'"]'))}}),q(e,a,b),{remove:D(a,b),update:function(){p(d,b);q(e,a,b);n(d,a,b)}}}},{match:function(a){return a.is("select")&&!z(a)?!0:!1},apply:function(a,b){var c,d,e,g;return b.selectAutoWidth&&C(a,function(){g=a.width()}),c=r(a,b,{divClass:b.selectClass,spanHtml:(a.find(":selected:first")||a.find("option:first")).html(),
spanWrap:"before"}),d=c.div,e=c.span,b.selectAutoWidth?C(a,function(){B(f([e[0],d[0]]),{display:"block"},function(){var a;a=e.outerWidth()-e.width();d.width(g+a);e.width(g)})}):d.addClass("fixedWidth"),l(a,d,b),k(a,b,{change:function(){e.html(a.find(":selected").html());d.removeClass(b.activeClass)},"click touchend":function(){},keyup:function(){e.html(a.find(":selected").html())}}),v(e,b),{remove:function(){return e.remove(),a.unwrap().unbind(b.eventNamespace),a},update:function(){b.selectAutoWidth?
(f.uniform.restore(a),a.uniform(b)):(p(d,b),e.html(a.find(":selected").html()),n(d,a,b))}}}},{match:function(a){return a.is("select")&&z(a)?!0:!1},apply:function(a,b){var c;return a.addClass(b.selectMultiClass),c=w(a,b),l(a,a,b),{remove:function(){a.removeClass(b.selectMultiClass);c&&a.unwrap()},update:u}}},{match:function(a){return a.is("textarea")},apply:function(a,b){var c;return a.addClass(b.textareaClass),c=w(a,b),l(a,a,b),{remove:function(){a.removeClass(b.textareaClass);c&&a.unwrap()},update:u}}}];
navigator.cpuClass&&!navigator.product&&void 0===window.XMLHttpRequest&&(x=!1);f.uniform={defaults:{activeClass:"active",autoHide:!0,buttonClass:"button",checkboxClass:"checker",checkedClass:"checked",disabledClass:"disabled",eventNamespace:".uniform",fileButtonClass:"action",fileButtonHtml:"Choose File",fileClass:"uploader",fileDefaultHtml:"No file selected",filenameClass:"filename",focusClass:"focus",hoverClass:"hover",idPrefix:"uniform",inputAddTypeAsClass:!0,inputClass:"uniform-input",radioClass:"radio",
resetDefaultHtml:"Reset",resetSelector:!1,selectAutoWidth:!0,selectClass:"selector",selectMultiClass:"uniform-multiselect",submitDefaultHtml:"Submit",textareaClass:"uniform",useID:!0,wrapperClass:null},elements:[]};f.fn.uniform=function(a){var b=this;return a=f.extend({},f.uniform.defaults,a),E||(E=!0,G()&&(x=!1)),x?(a.resetSelector&&f(a.resetSelector).mouseup(function(){window.setTimeout(function(){f.uniform.update(b)},10)}),this.each(function(){var b,d,e,g=f(this);if(g.data("uniformed"))return f.uniform.update(g),
void 0;for(b=0;F.length>b;b+=1)if(d=F[b],d.match(g,a))return e=d.apply(g,a),g.data("uniformed",e),f.uniform.elements.push(g.get(0)),void 0})):this};f.uniform.restore=f.fn.uniform.restore=function(a){a===y&&(a=f.uniform.elements);f(a).each(function(){var a,c,d=f(this);(c=d.data("uniformed"))&&(c.remove(),a=f.inArray(this,f.uniform.elements),0<=a&&f.uniform.elements.splice(a,1),d.removeData("uniformed"))})};f.uniform.update=f.fn.uniform.update=function(a){a===y&&(a=f.uniform.elements);f(a).each(function(){var a,
c=f(this);(a=c.data("uniformed"))&&a.update(c,a.options)})}})(jQuery);
...
//jquery validationEngine zh-TW
(function(a){a.fn.validationEngineLanguage=function(){};a.validationEngineLanguage={newLang:function(){a.validationEngineLanguage.allRules={required:{regex:"none",alertText:"\u6b64\u6b04\u4f4d\u4e0d\u53ef\u7a7a\u767d",alertTextCheckboxMultiple:"\u8acb\u9078\u64c7",alertTextCheckboxe:"\u60a8\u5fc5\u9700\u52fe\u9078\u6b64\u6b04\u4f4d",alertTextDateRange:"\u65e5\u671f\u7bc4\u570d\u6b04\u4f4d\u90fd\u4e0d\u53ef\u7a7a\u767d"},requiredInFunction:{func:function(a,b,c,d){return"test"==a.val()?!0:!1},alertText:"Field must equal test"},
dateRange:{regex:"none",alertText:"\u7121\u6548\u7684 ",alertText2:" \u65e5\u671f\u7bc4\u570d"},dateTimeRange:{regex:"none",alertText:"\u7121\u6548\u7684 ",alertText2:" \u6642\u9593\u7bc4\u570d"},minSize:{regex:"none",alertText:"\u6700\u5c11 ",alertText2:" \u500b\u5b57\u5143"},maxSize:{regex:"none",alertText:"\u6700\u591a ",alertText2:" \u500b\u5b57\u5143"},groupRequired:{regex:"none",alertText:"\u4f60\u5fc5\u9700\u9078\u586b\u5176\u4e2d\u4e00\u500b\u6b04\u4f4d"},min:{regex:"none",alertText:"\u6700\u5c0f\u503c\u70ba "},
max:{regex:"none",alertText:"\u6700\u5927\u503c\u70ba "},past:{regex:"none",alertText:"\u65e5\u671f\u5fc5\u9700\u65e9\u65bc "},future:{regex:"none",alertText:"\u65e5\u671f\u5fc5\u9700\u665a\u65bc "},maxCheckbox:{regex:"none",alertText:"\u6700\u591a\u9078\u53d6 ",alertText2:" \u500b\u9805\u76ee"},minCheckbox:{regex:"none",alertText:"\u8acb\u9078\u53d6 ",alertText2:" \u500b\u9805\u76ee"},equals:{regex:"none",alertText:"\u6b04\u4f4d\u5167\u5bb9\u4e0d\u76f8\u7b26"},creditCard:{regex:"none",alertText:"\u7121\u6548\u7684\u4fe1\u7528\u5361\u865f\u78bc"},
phone:{regex:/^([\+][0-9]{1,3}[ \.\-])?([\(]{1}[0-9]{2,6}[\)])?([0-9 \.\-\/]{3,20})((x|ext|extension)[ ]?[0-9]{1,4})?$/,alertText:"\u7121\u6548\u7684\u96fb\u8a71\u865f\u78bc"},email:{regex:/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i,
alertText:"Email\u683c\u5f0f\u6709\u8aa4"},integer:{regex:/^[\-\+]?\d+$/,alertText:"\u4e0d\u662f\u6709\u6548\u7684\u6574\u6578"},number:{regex:/^[\-\+]?((([0-9]{1,3})([,][0-9]{3})*)|([0-9]+))?([\.]([0-9]+))?$/,alertText:"\u7121\u6548\u7684\u6578\u5b57"},date:{regex:/^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])$/,alertText:"\u7121\u6548\u7684\u65e5\u671f\uff0c\u683c\u5f0f\u5fc5\u9700\u70ba YYYY-MM-DD"},ipv4:{regex:/^((([01]?[0-9]{1,2})|(2[0-4][0-9])|(25[0-5]))[.]){3}(([0-1]?[0-9]{1,2})|(2[0-4][0-9])|(25[0-5]))$/,
alertText:"\u7121\u6548\u7684 IP \u4f4d\u5740"},url:{regex:/^(https?|ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i,
alertText:"Invalid URL"},onlyNumberSp:{regex:/^[0-9\ ]+$/,alertText:"\u53ea\u80fd\u586b\u6578\u5b57"},onlyLetterSp:{regex:/^[a-zA-Z\ \']+$/,alertText:"\u53ea\u63a5\u53d7\u82f1\u6587\u5b57\u6bcd\u5927\u5c0f\u5beb"},onlyLetterNumber:{regex:/^[0-9a-zA-Z]+$/,alertText:"\u4e0d\u63a5\u53d7\u7279\u6b8a\u5b57\u5143"},ajaxUserCall:{url:"ajaxValidateFieldUser",extraData:"name=eric",alertText:"\u6b64\u540d\u7a31\u5df2\u7d93\u88ab\u5176\u4ed6\u4eba\u4f7f\u7528",alertTextLoad:"\u6b63\u5728\u78ba\u8a8d\u540d\u7a31\u662f\u5426\u6709\u5176\u4ed6\u4eba\u4f7f\u7528\uff0c\u8acb\u7a0d\u7b49\u3002"},
ajaxUserCallPhp:{url:"phpajax/ajaxValidateFieldUser.asp",extraData:"name=eric",alertTextOk:"\u6b64\u5e33\u865f\u540d\u7a31\u53ef\u4ee5\u4f7f\u7528",alertText:"\u6b64\u5e33\u865f\u540d\u7a31\u5df2\u7d93\u88ab\u5176\u4ed6\u4eba\u4f7f\u7528",alertTextLoad:"\u6b63\u5728\u78ba\u8a8d\u5e33\u865f\u540d\u7a31\u662f\u5426\u6709\u5176\u4ed6\u4eba\u4f7f\u7528\uff0c\u8acb\u7a0d\u7b49\u3002"},ajaxNameCall:{url:"ajaxValidateFieldName",alertText:"\u6b64\u540d\u7a31\u53ef\u4ee5\u4f7f\u7528",alertTextOk:"\u6b64\u540d\u7a31\u5df2\u7d93\u88ab\u5176\u4ed6\u4eba\u4f7f\u7528",
alertTextLoad:"\u6b63\u5728\u78ba\u8a8d\u540d\u7a31\u662f\u5426\u6709\u5176\u4ed6\u4eba\u4f7f\u7528\uff0c\u8acb\u7a0d\u7b49\u3002"},ajaxNameCallPhp:{url:"phpajax/ajaxValidateFieldName.asp",alertText:"\u6b64\u540d\u7a31\u5df2\u7d93\u88ab\u5176\u4ed6\u4eba\u4f7f\u7528",alertTextLoad:"\u6b63\u5728\u78ba\u8a8d\u540d\u7a31\u662f\u5426\u6709\u5176\u4ed6\u4eba\u4f7f\u7528\uff0c\u8acb\u7a0d\u7b49\u3002"},validate2fields:{alertText:"\u8acb\u8f38\u5165 HELLO"},dateFormat:{regex:/^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])$|^(?:(?:(?:0?[13578]|1[02])(\/|-)31)|(?:(?:0?[1,3-9]|1[0-2])(\/|-)(?:29|30)))(\/|-)(?:[1-9]\d\d\d|\d[1-9]\d\d|\d\d[1-9]\d|\d\d\d[1-9])$|^(?:(?:0?[1-9]|1[0-2])(\/|-)(?:0?[1-9]|1\d|2[0-8]))(\/|-)(?:[1-9]\d\d\d|\d[1-9]\d\d|\d\d[1-9]\d|\d\d\d[1-9])$|^(0?2(\/|-)29)(\/|-)(?:(?:0[48]00|[13579][26]00|[2468][048]00)|(?:\d\d)?(?:0[48]|[2468][048]|[13579][26]))$/,
alertText:"\u7121\u6548\u7684\u65e5\u671f\u683c\u5f0f"},dateTimeFormat:{regex:/^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])\s+(1[012]|0?[1-9]){1}:(0?[1-5]|[0-6][0-9]){1}:(0?[0-6]|[0-6][0-9]){1}\s+(am|pm|AM|PM){1}$|^(?:(?:(?:0?[13578]|1[02])(\/|-)31)|(?:(?:0?[1,3-9]|1[0-2])(\/|-)(?:29|30)))(\/|-)(?:[1-9]\d\d\d|\d[1-9]\d\d|\d\d[1-9]\d|\d\d\d[1-9])$|^((1[012]|0?[1-9]){1}\/(0?[1-9]|[12][0-9]|3[01]){1}\/\d{2,4}\s+(1[012]|0?[1-9]){1}:(0?[1-5]|[0-6][0-9]){1}:(0?[0-6]|[0-6][0-9]){1}\s+(am|pm|AM|PM){1})$/,
alertText:"\u7121\u6548\u7684\u65e5\u671f\u6216\u6642\u9593\u683c\u5f0f",alertText2:"\u53ef\u63a5\u53d7\u7684\u683c\u5f0f\uff1a ",alertText3:"mm/dd/yyyy hh:mm:ss AM|PM \u6216 ",alertText4:"yyyy-mm-dd hh:mm:ss AM|PM"}}}};a.validationEngineLanguage.newLang()})(jQuery);
/*
 ...
 */
(function(g){Array.indexOf||(Array.prototype.indexOf=function(a){for(var b=0;b<this.length;b++)if(this[b]==a)return b;return-1});var f={init:function(a){this.data("jqv")&&null!=this.data("jqv")||(a=f._saveOptions(this,a),g(document).on("click",".formError",function(){g(this).fadeOut(150,function(){g(this).parent(".formErrorOuter").remove();g(this).remove()})}));return this},attach:function(a){a=a?f._saveOptions(this,a):this.data("jqv");a.validateAttribute=this.find("[data-validation-engine*=validate]").length?
"data-validation-engine":"class";a.binded&&(this.on(a.validationEventTrigger,"["+a.validateAttribute+"*=validate]:not([type=checkbox]):not([type=radio]):not(.datepicker)",f._onFieldEvent),this.on("click","["+a.validateAttribute+"*=validate][type=checkbox],["+a.validateAttribute+"*=validate][type=radio]",f._onFieldEvent),this.on(a.validationEventTrigger,"["+a.validateAttribute+"*=validate][class*=datepicker]",{delay:300},f._onFieldEvent));a.autoPositionUpdate&&g(window).bind("resize",{noAnimation:!0,
formElem:this},f.updatePromptsPosition);this.on("click","a[data-validation-engine-skip], a[class*='validate-skip'], button[data-validation-engine-skip], button[class*='validate-skip'], input[data-validation-engine-skip], input[class*='validate-skip']",f._submitButtonClick);this.removeData("jqv_submitButton");this.on("submit",f._onSubmitEvent);return this},detach:function(){var a=this.data("jqv");this.find("["+a.validateAttribute+"*=validate]").not("[type=checkbox]").off(a.validationEventTrigger,f._onFieldEvent);
this.find("["+a.validateAttribute+"*=validate][type=checkbox],[class*=validate][type=radio]").off("click",f._onFieldEvent);this.off("submit",f._onSubmitEvent);this.removeData("jqv");this.off("click","a[data-validation-engine-skip], a[class*='validate-skip'], button[data-validation-engine-skip], button[class*='validate-skip'], input[data-validation-engine-skip], input[class*='validate-skip']",f._submitButtonClick);this.removeData("jqv_submitButton");a.autoPositionUpdate&&g(window).off("resize",f.updatePromptsPosition);
return this},validate:function(){var a=g(this),b=null;if(a.is("form")||a.hasClass("validationEngineContainer")){if(a.hasClass("validating"))return!1;a.addClass("validating");var c=a.data("jqv"),b=f._validateFields(this);setTimeout(function(){a.removeClass("validating")},100);if(b&&c.onSuccess)c.onSuccess();else if(!b&&c.onFailure)c.onFailure()}else if(a.is("form")||a.hasClass("validationEngineContainer"))a.removeClass("validating");else{var e=a.closest("form, .validationEngineContainer"),c=e.data("jqv")?
e.data("jqv"):g.validationEngine.defaults;if((b=f._validateField(a,c))&&c.onFieldSuccess)c.onFieldSuccess();else if(c.onFieldFailure&&0<c.InvalidFields.length)c.onFieldFailure()}return c.onValidationComplete?!!c.onValidationComplete(e,b):b},updatePromptsPosition:function(a){if(a&&this==window)var b=a.data.formElem,c=a.data.noAnimation;else b=g(this.closest("form, .validationEngineContainer"));var e=b.data("jqv");b.find("["+e.validateAttribute+"*=validate]").not(":disabled").each(function(){var a=
g(this);e.prettySelect&&a.is(":hidden")&&(a=b.find("#"+e.usePrefix+a.attr("id")+e.useSuffix));var h=f._getPrompt(a),k=g(h).find(".formErrorContent").html();h&&f._updatePrompt(a,g(h),k,void 0,!1,e,c)});return this},showPrompt:function(a,b,c,e){var d=this.closest("form, .validationEngineContainer").data("jqv");d||(d=f._saveOptions(this,d));c&&(d.promptPosition=c);d.showArrow=1==e;f._showPrompt(this,a,b,!1,d);return this},hide:function(){var a=g(this).closest("form, .validationEngineContainer").data("jqv"),
a=a&&a.fadeDuration?a.fadeDuration:0,b;b=g(this).is("form")||g(this).hasClass("validationEngineContainer")?"parentForm"+f._getClassName(g(this).attr("id")):f._getClassName(g(this).attr("id"))+"formError";g("."+b).fadeTo(a,0,function(){g(this).parent(".formErrorOuter").remove();g(this).remove()});return this},hideAll:function(){var a=this.data("jqv"),a=a?a.fadeDuration:0;g(".formError").fadeTo(a,0,function(){g(this).parent(".formErrorOuter").remove();g(this).remove()});return this},_onFieldEvent:function(a){var b=
...
g(this),h=[];if(0>g.inArray(d.attr("name"),h)){(c|=f._validateField(d,b))&&null==e&&(d.is(":hidden")&&b.prettySelect?e=d=a.find("#"+b.usePrefix+f._jqSelector(d.attr("id"))+b.useSuffix):(d.data("jqv-prompt-at")instanceof jQuery?d=d.data("jqv-prompt-at"):d.data("jqv-prompt-at")&&(d=g(d.data("jqv-prompt-at"))),e=d));if(b.doNotShowAllErrosOnSubmit)return!1;h.push(d.attr("name"));if(1==b.showOneMessage&&c)return!1}});a.trigger("jqv.form.result",[c]);if(c){if(b.scroll){var d=e.offset().top,h=e.offset().left,
k=b.promptPosition;"string"==typeof k&&-1!=k.indexOf(":")&&(k=k.substring(0,k.indexOf(":")));"bottomRight"!=k&&"bottomLeft"!=k&&(k=f._getPrompt(e))&&(d=k.offset().top);b.scrollOffset&&(d-=b.scrollOffset);if(b.isOverflown){k=g(b.overflownDIV);if(!k.length)return!1;h=k.scrollTop();k=-parseInt(k.offset().top);d+=h+k-5;g(b.overflownDIV+":not(:animated)").animate({scrollTop:d},1100,function(){b.focusFirstField&&e.focus()})}else g("html, body").animate({scrollTop:d},1100,function(){b.focusFirstField&&e.focus()}),
g("html, body").animate({scrollLeft:h},1100)}else b.focusFirstField&&e.focus();return!1}return!0},_validateFormWithAjax:function(a,b){var c=a.serialize(),e=b.ajaxFormValidationMethod?b.ajaxFormValidationMethod:"GET",d=b.ajaxFormValidationURL?b.ajaxFormValidationURL:a.attr("action"),h=b.dataType?b.dataType:"json";g.ajax({type:e,url:d,cache:!1,dataType:h,data:c,form:a,methods:f,options:b,beforeSend:function(){return b.onBeforeAjaxFormValidation(a,b)},error:function(a,c){if(b.onFailure)b.onFailure(a,
c);else f._ajaxError(a,c)},success:function(c){if("json"==h&&!0!==c){for(var d=!1,e=0;e<c.length;e++){var m=c[e],l=g(g("#"+m[0])[0]);if(1==l.length){var k=m[2];1==m[1]?""!=k&&k?(b.allrules[k]&&(m=b.allrules[k].alertTextOk)&&(k=m),b.showPrompts&&f._showPrompt(l,k,"pass",!1,b,!0)):f._closePrompt(l):(d|=1,b.allrules[k]&&(m=b.allrules[k].alertText)&&(k=m),b.showPrompts&&f._showPrompt(l,k,"",!1,b,!0))}}b.onAjaxFormComplete(!d,a,c,b)}else b.onAjaxFormComplete(!0,a,c,b)}})},_validateField:function(a,b,c){a.attr("id")||
(a.attr("id","form-validation-field-"+g.validationEngine.fieldIdCounter),++g.validationEngine.fieldIdCounter);if(!b.validateNonVisibleFields&&(a.is(":hidden")&&!b.prettySelect||a.parent().is(":hidden")))return!1;var e=a.attr(b.validateAttribute),e=/validate\[(.*)\]/.exec(e);if(!e)return!1;var d=e[1].split(/\[|,|\]/),e=a.attr("name"),h="",k="",p=!1,q=!1;b.isError=!1;b.showArrow=!0;0<b.maxErrorsPerField&&(q=!0);for(var m=g(a.closest("form, .validationEngineContainer")),l=0;l<d.length;l++)d[l]=d[l].replace(" ",
""),""===d[l]&&delete d[l];for(var t=l=0;l<d.length;l++){if(q&&t>=b.maxErrorsPerField){p||(c=g.inArray("required",d),p=-1!=c&&c>=l);break}var n=void 0;switch(d[l]){case "required":p=!0;n=f._getErrorMessage(m,a,d[l],d,l,b,f._required);break;case "custom":n=f._getErrorMessage(m,a,d[l],d,l,b,f._custom);break;case "groupRequired":var r="["+b.validateAttribute+"*="+d[l+1]+"]",n=m.find(r).eq(0);n[0]!=a[0]&&(f._validateField(n,b,c),b.showArrow=!0);(n=f._getErrorMessage(m,a,d[l],d,l,b,f._groupRequired))&&
(p=!0);b.showArrow=!1;break;case "ajax":(n=f._ajax(a,d,l,b))&&(k="load");break;case "minSize":n=f._getErrorMessage(m,a,d[l],d,l,b,f._minSize);break;case "maxSize":n=f._getErrorMessage(m,a,d[l],d,l,b,f._maxSize);break;case "min":n=f._getErrorMessage(m,a,d[l],d,l,b,f._min);break;case "max":n=f._getErrorMessage(m,a,d[l],d,l,b,f._max);break;case "past":n=f._getErrorMessage(m,a,d[l],d,l,b,f._past);break;case "future":n=f._getErrorMessage(m,a,d[l],d,l,b,f._future);break;case "dateRange":r="["+b.validateAttribute+
"*="+d[l+1]+"]";b.firstOfGroup=m.find(r).eq(0);b.secondOfGroup=m.find(r).eq(1);if(b.firstOfGroup[0].value||b.secondOfGroup[0].value)n=f._getErrorMessage(m,a,d[l],d,l,b,f._dateRange);n&&(p=!0);b.showArrow=!1;break;case "dateTimeRange":r="["+b.validateAttribute+"*="+d[l+1]+"]";b.firstOfGroup=m.find(r).eq(0);b.secondOfGroup=m.find(r).eq(1);if(b.firstOfGroup[0].value||b.secondOfGroup[0].value)n=f._getErrorMessage(m,a,d[l],d,l,b,f._dateTimeRange);n&&(p=!0);b.showArrow=!1;break;case "maxCheckbox":a=g(m.find("input[name='"+
e+"']"));n=f._getErrorMessage(m,a,d[l],d,l,b,f._maxCheckbox);break;case "minCheckbox":a=g(m.find("input[name='"+e+"']"));n=f._getErrorMessage(m,a,d[l],d,l,b,f._minCheckbox);break;case "equals":n=f._getErrorMessage(m,a,d[l],d,l,b,f._equals);break;case "funcCall":n=f._getErrorMessage(m,a,d[l],d,l,b,f._funcCall);break;case "creditCard":n=f._getErrorMessage(m,a,d[l],d,l,b,f._creditCard);break;case "condRequired":n=f._getErrorMessage(m,a,d[l],d,l,b,f._condRequired),void 0!==n&&(p=!0)}r=!1;if("object"==
typeof n)switch(n.status){case "_break":r=!0;break;case "_error":n=n.message;break;case "_error_no_prompt":return!0}if(r)break;"string"==typeof n&&(h+=n+"<br/>",b.isError=!0,t++)}!p&&!a.val()&&1>a.val().length&&0>d.indexOf("equals")&&(b.isError=!1);c=a.prop("type");d=a.data("promptPosition")||b.promptPosition;("radio"==c||"checkbox"==c)&&1<m.find("input[name='"+e+"']").size()&&(a="inline"===d?g(m.find("input[name='"+e+"'][type!=hidden]:last")):g(m.find("input[name='"+e+"'][type!=hidden]:first")),
b.showArrow=!1);a.is(":hidden")&&b.prettySelect&&(a=m.find("#"+b.usePrefix+f._jqSelector(a.attr("id"))+b.useSuffix));b.isError&&b.showPrompts?f._showPrompt(a,h,k,!1,b):f._closePrompt(a);a.trigger("jqv.field.result",[a,b.isError,h]);e=g.inArray(a[0],b.InvalidFields);-1==e?b.isError&&b.InvalidFields.push(a[0]):b.isError||b.InvalidFields.splice(e,1);f._handleStatusCssClasses(a,b);if(b.isError&&b.onFieldFailure)b.onFieldFailure(a);if(!b.isError&&b.onFieldSuccess)b.onFieldSuccess(a);return b.isError},
_handleStatusCssClasses:function(a,b){b.addSuccessCssClassToField&&a.removeClass(b.addSuccessCssClassToField);b.addFailureCssClassToField&&a.removeClass(b.addFailureCssClassToField);b.addSuccessCssClassToField&&!b.isError&&a.addClass(b.addSuccessCssClassToField);b.addFailureCssClassToField&&b.isError&&a.addClass(b.addFailureCssClassToField)},_getErrorMessage:function(a,b,c,e,d,h,k){var p=jQuery.inArray(c,e);if("custom"===c||"funcCall"===c)c=c+"["+e[p+1]+"]",delete e[p];var p=c,q=(b.attr("data-validation-engine")?
b.attr("data-validation-engine"):b.attr("class")).split(" ");a="future"==c||"past"==c||"maxCheckbox"==c||"minCheckbox"==c?k(a,b,e,d,h):k(b,e,d,h);void 0!=a&&(b=f._getCustomErrorMessage(g(b),q,p,h))&&(a=b);return a},_getCustomErrorMessage:function(a,b,c,e){var d;d=/^custom\[.*\]$/.test(c)?f._validityProp.custom:f._validityProp[c];if(void 0!=d&&(d=a.attr("data-errormessage-"+d),void 0!=d))return d;d=a.attr("data-errormessage");if(void 0!=d)return d;a="#"+a.attr("id");if("undefined"!=typeof e.custom_error_messages[a]&&
...
a=g(a.find("*[name='"+c.replace(/^#+/,"")+"']"));if("now"==c.toLowerCase())a=new Date;else if(void 0!=a.val()){if(a.is(":disabled"))return;a=f._parseDate(a.val())}else a=f._parseDate(c);if(f._parseDate(b.val())>a)return b=d.allrules.past,b.alertText2?b.alertText+f._dateToString(a)+b.alertText2:b.alertText+f._dateToString(a)},_future:function(a,b,c,e,d){c=c[e+1];a=g(a.find("*[name='"+c.replace(/^#+/,"")+"']"));if("now"==c.toLowerCase())a=new Date;else if(void 0!=a.val()){if(a.is(":disabled"))return;
...
_ajax:function(a,b,c,e){var d=e.allrules[b[c+1]];c=d.extraData;var h=d.extraDataDynamic;b={fieldId:a.attr("id"),fieldValue:a.val()};if("object"===typeof c)g.extend(b,c);else if("string"===typeof c){var k=c.split("&");for(c=0;c<k.length;c++){var p=k[c].split("=");p[0]&&p[0]&&(b[p[0]]=p[1])}}if(h)for(h=String(h).split(","),c=0;c<h.length;c++)k=h[c],g(k).length&&(p=a.closest("form, .validationEngineContainer").find(k).val(),k.replace("#",""),escape(p),b[k.replace("#","")]=p);"field"==e.eventTrigger&&
delete e.ajaxValidCache[a.attr("id")];if(!e.isError&&!f._checkAjaxFieldStatus(a.attr("id"),e))return g.ajax({type:e.ajaxFormValidationMethod,url:d.url,cache:!1,dataType:"json",data:b,field:a,rule:d,methods:f,options:e,beforeSend:function(){},error:function(a,b){if(e.onFailure)e.onFailure(a,b);else f._ajaxError(a,b)},success:function(b){var c=b[0],h=g("#"+c).eq(0);if(1==h.length){var k=b[2];b[1]?(e.ajaxValidCache[c]=!0,k?e.allrules[k]&&(b=e.allrules[k].alertTextOk)&&(k=b):k=d.alertTextOk,e.showPrompts&&
(k?f._showPrompt(h,k,"pass",!0,e):f._closePrompt(h)),"submit"==e.eventTrigger&&a.closest("form").submit()):(e.ajaxValidCache[c]=!1,e.isError=!0,k?e.allrules[k]&&(b=e.allrules[k].alertText)&&(k=b):k=d.alertText,e.showPrompts&&f._showPrompt(h,k,"",!0,e))}h.trigger("jqv.field.result",[h,e.isError,k])}}),d.alertTextLoad},_ajaxError:function(a,b){0==a.status&&null==b?alert("The page is not served from a server! ajax call failed"):"undefined"!=typeof console&&console.log("Ajax error: "+a.status+" "+b)},
_dateToString:function(a){return a.getFullYear()+"-"+(a.getMonth()+1)+"-"+a.getDate()},_parseDate:function(a){var b=a.split("-");b==a&&(b=a.split("/"));return b==a?(b=a.split("."),new Date(b[2],b[1]-1,b[0])):new Date(b[0],b[1]-1,b[2])},_showPrompt:function(a,b,c,e,d,h){a.data("jqv-prompt-at")instanceof jQuery?a=a.data("jqv-prompt-at"):a.data("jqv-prompt-at")&&(a=g(a.data("jqv-prompt-at")));var k=f._getPrompt(a);h&&(k=!1);g.trim(b)&&(k?f._updatePrompt(a,k,b,c,e,d):f._buildPrompt(a,b,c,e,d))},_buildPrompt:function(a,
b,c,e,d){var h=g("<div>");h.addClass(f._getClassName(a.attr("id"))+"formError");h.addClass("parentForm"+f._getClassName(a.closest("form, .validationEngineContainer").attr("id")));h.addClass("formError");switch(c){case "pass":h.addClass("greenPopup");break;case "load":h.addClass("blackPopup")}e&&h.addClass("ajaxed");g("<div>").addClass("formErrorContent").html(b).appendTo(h);b=a.data("promptPosition")||d.promptPosition;if(d.showArrow)switch(c=g("<div>").addClass("formErrorArrow"),"string"==typeof b&&
(e=b.indexOf(":"),-1!=e&&(b=b.substring(0,e))),b){case "bottomLeft":case "bottomRight":h.find(".formErrorContent").before(c);c.addClass("formErrorArrowBottom").html('<div class="line1">\x3c!-- --\x3e</div><div class="line2">\x3c!-- --\x3e</div><div class="line3">\x3c!-- --\x3e</div><div class="line4">\x3c!-- --\x3e</div><div class="line5">\x3c!-- --\x3e</div><div class="line6">\x3c!-- --\x3e</div><div class="line7">\x3c!-- --\x3e</div><div class="line8">\x3c!-- --\x3e</div><div class="line9">\x3c!-- --\x3e</div><div class="line10">\x3c!-- --\x3e</div>');
...
"absolute",top:e.callerTopPosition,left:e.callerleftPosition,marginTop:e.marginTopSize,opacity:0}).data("callerField",a);d.autoHidePrompt&&setTimeout(function(){h.animate({opacity:0},function(){h.closest(".formErrorOuter").remove();h.remove()})},0);return h.animate({opacity:1},0)},_updatePrompt:function(a,b,c,e,d,g,k){b&&("undefined"!==typeof e&&("pass"==e?b.addClass("greenPopup"):b.removeClass("greenPopup"),"load"==e?b.addClass("blackPopup"):b.removeClass("blackPopup")),d?b.addClass("ajaxed"):b.removeClass("ajaxed"),
b.find(".formErrorContent").html(c),a=f._calculatePosition(a,b,g),a={top:a.callerTopPosition,left:a.callerleftPosition,marginTop:a.marginTopSize},k?b.css(a,0):b.animate(a,0))},_closePrompt:function(a){var b=f._getPrompt(a);b&&b.fadeTo("fast",0,function(){b.parent(".formErrorOuter").remove();b.remove()})},closePrompt:function(a){return f._closePrompt(a)},_getPrompt:function(a){var b=g(a).closest("form, .validationEngineContainer").attr("id");a=f._getClassName(a.attr("id"))+"formError";if(b=g("."+f._escapeExpression(a)+
".parentForm"+f._getClassName(b))[0])return g(b)},_escapeExpression:function(a){return a.replace(/([#;&,\.\+\*\~':"\!\^$\[\]\(\)=>\|])/g,"\\$1")},isRTL:function(a){var b=g(document),c=g("body");return!!(a&&a.hasClass("rtl")||a&&"rtl"===(a.attr("dir")||"").toLowerCase()||b.hasClass("rtl")||"rtl"===(b.attr("dir")||"").toLowerCase()||c.hasClass("rtl")||"rtl"===(c.attr("dir")||"").toLowerCase())},_calculatePosition:function(a,b,c){var e,d,f,g=a.width(),p=a.position().left,q=a.position().top;a.height();
f=b.height();e=d=0;f=-f;c=a.data("promptPosition")||c.promptPosition;var m,l,t=l=0;"string"==typeof c&&-1!=c.indexOf(":")&&(m=c.substring(c.indexOf(":")+1),c=c.substring(0,c.indexOf(":")),-1!=m.indexOf(",")&&(l=m.substring(m.indexOf(",")+1),m=m.substring(0,m.indexOf(",")),t=parseInt(l),isNaN(t)&&(t=0)),l=parseInt(m),isNaN(m));switch(c){default:case "topRight":d+=p+g-30;e+=q;break;case "topLeft":e+=q;d+=p;break;case "centerRight":e=q;f=0;d=p+a.outerWidth(!0)+5;break;case "centerLeft":d=p-b.outerWidth();
e=q;f=0;break;case "bottomLeft":a=a.outerHeight();30>a&&(a=30);e=0+a;f=0;d=p;break;case "bottomRight":d=p+g-30;e=q+a.outerHeight();f=0;break;case "inline":f=e=d=0}return{callerTopPosition:e+t+"px",callerleftPosition:d+l+"px",marginTopSize:f+"px"}},_saveOptions:function(a,b){if(g.validationEngineLanguage)var c=g.validationEngineLanguage.allRules;else g.error("jQuery.validationEngine rules are not loaded, plz add localization files to the page");g.validationEngine.defaults.allrules=c;c=g.extend(!0,
